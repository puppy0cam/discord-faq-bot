...
export function handleRemovefaqCommand(interaction: APIChatInputApplicationCommandGuildInteraction, env: Env, context: FetchEvent): Response {
    ...
    context.waitUntil(callbackRemovefaq(interaction, env));
