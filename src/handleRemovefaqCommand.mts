...
import { callbackRemovefaq } from "./callbackRemovefaq.mjs";
import { createJsonResponse } from "./createJsonResponse.mjs";
import type { Env } from "./env.mjs";
import { getCommandParameter } from "./getCommandParameter.mjs";

export function handleRemovefaqCommand(interaction: APIChatInputApplicationCommandInteraction, env: Env, context: ExecutionContext): Response {
    ...
    context.waitUntil(callbackRemovefaq(interaction, env, question));
