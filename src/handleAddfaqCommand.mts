...
export function handleAddfaqCommand(interaction: APIChatInputApplicationCommandGuildInteraction, env: Env, context: FetchEvent): Response {
    ...
    context.waitUntil(callbackAddfaq(interaction, env));
